...
namespace OpenChat.PlaygroundApp.Services.Ingestion;
    ...
    IngestionCacheDbContext ingestionCacheDb)
{
    ...
    {
        var vectorCollection = vectorStore.GetCollection<string, SemanticSearchRecord>("data-openchat_playgroundapp-ingested");
