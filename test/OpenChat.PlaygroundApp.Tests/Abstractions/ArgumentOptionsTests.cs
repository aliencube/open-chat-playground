...
public class ArgumentOptionsTests
{
    ...
    [InlineData(AppSettingConstants.ConnectorType, "FoundryLocal", "FoundryLocal:AliasOrModel", "test-alias", "test-alias")]
    ...
    [InlineData(AppSettingConstants.ConnectorType, "FoundryLocal", "FoundryLocal:AliasOrModel", "config-alias", "config-alias")]
